...
void ofApp::setup(){
	...
	motion[0].setup(ofxMotion::DrawMode::RECT, vec2(200, 200), vec2(1.0, 1.0), 200, 200, 0.0f, ofColor(ofRandom(0, 255), ofRandom(0, 255), ofRandom(0, 255)), ofxMotion::AnchorMode::ANCHOR_CENTER, 0, true);
	motion[1].setup(ofxMotion::DrawMode::CIRCLE, vec2(200 + 200, 200), vec2(1.0, 1.0), 200, 200, 0.0f, ofColor(ofRandom(0, 255), ofRandom(0, 255), ofRandom(0, 255)), ofxMotion::AnchorMode::ANCHOR_CENTER, 0, true);
	motion[2].setup(ofxMotion::DrawMode::TRIANGLE, vec2(200 + 400, 200), vec2(1.0, 1.0), 200, 200, 0.0f, ofColor(ofRandom(0, 255), ofRandom(0, 255), ofRandom(0, 255)), ofxMotion::AnchorMode::ANCHOR_CENTER, 0, true);

	image.load("image_fx_1.jpg");
	motion[3].setup(ofxMotion::DrawMode::IMAGE, &image, vec2(200, 400), vec2(1.0, 1.0), image.getWidth(), image.getHeight(), 0.0f, ofxMotion::AnchorMode::ANCHOR_CENTER, 0, true);
	...
	motion[4].setup(ofxMotion::DrawMode::TEXTURE, &texture, vec2(200 + 200, 400), vec2(1.0, 1.0), texture.getWidth(), texture.getHeight(), 0.0f, ofxMotion::AnchorMode::ANCHOR_CENTER, 0, true);
